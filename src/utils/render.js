const renderMen = () => {
  const itemsData = [
    ...
    },
    {
      name: "RichLook",
      imgSrc: "/men3.png",
      description: "Tartan Checked Shirt",
      price: "$69",
      strike: "$99",
      cutprice: "$199"
    },
    ...
    },
    {
      name: "Parx",
      imgSrc: "/men5.png",
      description: "Tapered Fit Trousers",
      price: "$69",
      cutprice: "$99"
    },
    ...
    },
    {
      name: "Pepe Jeans",
      imgSrc: "/men7.png",
      description: "Pure Cotton Boxers",
      price: "$29",
      cutprice: "$39"
    },
    {
      name: "H & M",
      imgSrc: "/men8.png",
      description: "Men Fit SweatShirt",
      price: "$53",
      strike: "$76",
      cutprice: "$98"
    },
  ...
  function renderItems() {
    const itemsContainer = document.querySelector(".men__wears__list");
    ...
    for (let i = 0; i < numItemsToShowInitially && i < itemsData.length; i++) {
      ...
      itemElement.classList.add("men_item");
      itemElement.setAttribute("data-item-name", item.name);

      itemElement.innerHTML = `
        <div class="men__img">
          <img id="menImg" src="${item.imgSrc}">
    ...
    if (numItemsToShowInitially < itemsData.length) {
      ...
      seeMoreButton.classList.add("men__seeMore");
